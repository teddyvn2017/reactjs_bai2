    ...
    <section className="mt-12">
        <div className="container max-w-[1280px]">
            <div className="flex flex-row items-center gap-4">
                <h1 className="text-[34px] text-title font-semibold">
                    Recent Blog
                </h1>
                <h3 className="text-title text-xl underline underline-offset-8 decoration-2 decoration-mau_den ml-auto">View All Posts</h3>
            </div>
            <div className="mt-8">
